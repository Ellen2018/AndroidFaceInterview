...
- 8.谈谈线程池的7大核心参数 & 线程池有哪几种饱和策略？
- 9.给我谈谈你是如何保证线程数据安全问题的？
- 10.wait()和sleep()的区别？
- 11.什么是公平锁&非公平锁&区别？锁的分类。
- 12.给我讲讲线程间通信
- 13.volatile关键字是如何使用的？原理是什么
- 14.说说使用5个线程去计算一个数组之和的思路。
- 15.谈谈线程阻塞的原因有哪些？
- 16.谈谈你对notify的理解？
- 17.你觉得Lock和Synchronized的区别是什么？
- 18.谈谈你对ReentrantLock的认识。
- 19.调用run()和start()的区别？
- 20.transient关键字的用法 & 作用 & 原理。
- 21.线程池的种类  & 工作原理 & ThreadPoolExecutor的工作策略有哪些？
- 22.ThreadLocal了解吗？说说原理。
- 23.权衡多线程的性能。
- 24.如何理解同步和异步，阻塞和非阻塞。
- 25.比较一下线程和协程。
...
- 1.给我介绍5层网络模型。
- 2.Http/Https协议工作在哪一层？试着说说https加密过程 & 为什么https比http要安全？
- 3.TCP/UDP协议工作在哪一层？IP协议工作在哪一层？应用层有哪些协议？
- 4.给我说说三次握手和四次挥手。
